import { level as level1 } from "./level.js?v=84";
import { level as level2 } from "./spaceLevel.js?v=14";
import { level as level3 } from "./jungleLevel.js?v=53";
import { level as level4 } from "./titanicLevel.js?v=65";
